...
// Load Profile and Experience Validation
...
// @Desc description Tests posts route
// @access Public 
            ...
            Post.findById(req.params.id)
                .then(post => {
                    ...
                    if (post.user.toString() !== req.user.id) {
                        return res.status(401).json({ notautherize: 'User not autherize' });
                    }
